...
$(document).ready(function () {
    ...
    function recalculation() {
        ...
        itemLine.each(function (i, el) {
            ...
            var weight = parseFloat($(this).find('.product-weight-by1').val(), 10);
            ...
            totalWeight += parseFloat(itemsData[i].itemWeight);
        });
        ...
        if($.isEmptyObject(itemsData) == false) {
        	...
        	$.post(
                url_cart_update + url, {
					...
					totalSumWithDelivery = (totalWeight * 0.42 - parseFloat(coupon_sum) + parseFloat(totalSum)).toFixed(2);

                    total.text(totalSumWithDelivery);
                    totalWeightText.text(totalWeight);
                    totalDeliveryByWeight.text((totalWeight * 0.42).toFixed(2));
