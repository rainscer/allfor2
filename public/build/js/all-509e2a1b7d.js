            ...
            .done(function (data) {
                ...
                if (data.result == 'OK') {
                    ...
                    if(el.data('payment') == 'wayforpay'){
                        ...
                        console.log(data.hash_order_url);
