...
@section('content')
    <div class="panel panel-success">
        ...
        <div class="panel-body">
            ...
            {!! Form::model($coupon,['url' => route('coupon.edit', $coupon->id)]) !!}
            ...
            <div class="col-xs-12 form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        ...
                        <div class="input-group">
                            {!! Form::text('code', null, ['class' => 'form-control code', 'required'] ) !!}
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        {!! Form::input('number', 'count', null, ['class'=>'form-control', 'min' => 1, 'required'] ) !!}
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        {!! Form::input('number', 'amount', null, ['class'=>'form-control', 'min' => 1, 'step' => 'any', 'required'] ) !!}
                    </div>
                </div>
