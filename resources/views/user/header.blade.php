<div class="profile-user clearfix">
    ...
    <div class="profile-data container-fluid">
        <div class="profile-col">
            <p class="profile-username" style="margin-bottom: auto;">{{ $user->getFullName() }}</p>
            <p class="profile-date" style="margin-bottom: auto;"> {{ trans('user.memberSince') }} {{  $user->created_at }} {{--{{ trans('user.memberYear')}}--}} </p>
        ...
        <div class="profile-col profile-col-2 row" style="padding-top: 30px;">
