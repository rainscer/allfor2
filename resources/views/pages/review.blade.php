@extends('layout.app')
@section('content')
    <div class="product-reviews-head">{{ trans('home.reviews') }}</div>
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
    {!! Form::open(array('action' => 'ProductController@searchReviews', 'id' => 'search_form_reviews', 'class' => 'form-horizontal'))!!}
    <div class="form-group">
    <div class="col-sm-11">
        {!! Form::text('search_review', isset($search_review) ? $search_review : '', ['class'=>'form-control', 'placeholder' => trans('cart.productName')] ) !!}
     </div>
    <div class="col-sm-1">
        {!! Form::submit(trans('cart.search'), ['class'=>'btn btn-primary']) !!}
    </div>
    </div>
    {!! Form::close()!!}
        </div>
