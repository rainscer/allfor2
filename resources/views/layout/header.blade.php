<div id="header-main" class="head container-fluid default">
    <div class="col-xs-3 col-md-2 col-sm-2 col-lg-2 logo-block" style="margin-top: 2px;">
        <a class="logo white_color" href="{{ url('/') }}">
            <img class="img-logo" src="{{ asset('images/logo.png') }}" alt="{{ trans('home.title') }}" style="max-width: 78px;" />
        </a>
        {{--
    ...
    <div class="col-xs-12 col-md-2 phone_mobile">
        <div class="phones_data">
            <a href="{{ url('contacts') }}" class="modalFormToggle">#{{ trans('home.menuContactUs') }}</a>
            <a href="{{ url('aboutUs') }}"  class="modalFormToggle">#{{ trans('home.menuAboutUs') }}</a>
            <a href="{{ url('deliveryInfo') }}" class="modalFormToggle">#{{ trans('home.menuDelivery') }}</a>
            <a href="{{ url('payment') }}" class="modalFormToggle">#{{ trans('home.menuPayments') }}</a>
        </div>
    </div>
