        ...
        <div class="panel panel-success">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    {!! Form::submit('Импорт категорий товаров', ['class'=>'btn btn-primary']) !!}
                </div>
                {!! Form::close()!!}
                ...
                <div class="form-group">
                    {!! Form::submit('Импорт товаров с полки', ['class'=>'btn btn-primary']) !!}
                </div>
                {!! Form::close()!!}
                {!! Form::open(array('action' => 'ProductController@deleteAll')) !!}
                <div class="form-group">
                    {!! Form::submit('Удалить все товары', ['class'=>'btn btn-primary']) !!}
                </div>
                {!! Form::close()!!}
