        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="panel panel-success">
                    <div class="panel-heading">Письмо</div>
                    <div class="panel-body">
                        {!! Form::model($mail,['route' => ['mail.update', $mail->id], 'class' => 'form-horizontal']) !!}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                {!! Form::select('emails', $email_list, $mail->participants_array, ['class' => 'form-control chosen-select', 'multiple'=>'multiple', 'name'=>'emails[]']) !!}
                            </div>
                        </div>
