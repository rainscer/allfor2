<div class="form-group">
    {!! Form::label('name_ru','Name',['class'=>'col-sm-2 control-label required']) !!}
    <div class="col-sm-10">
        ...
        @endif
        {!! Form::text('name_ru', null, ['class'=>'form-control', 'id' => 'name'] ) !!}
    </div>
</div>
<div class="form-group">
    ...
    <div class="col-xs-10">
        <div style="margin-bottom:20px;">
            <label class="radio-inline">
                {!! Form::radio('delivery_type', 0, isset($product) ? ($product->delivery_type ? false : true) : false) !!} 10 days
            </label>
            <label class="radio-inline">
...
<div class="form-group">
    {!! Form::label('description_ru','Description',['class'=>'col-sm-2 control-label required']) !!}
    <div class="col-sm-10">
