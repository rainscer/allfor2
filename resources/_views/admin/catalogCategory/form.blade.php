...
<div class="form-group">
    {!! Form::label('name_ru', 'name:', ['class' => 'col-sm-4 control-label required']) !!}
    <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
        {!! Form::text('name_ru',null ,['class' => 'form-control','required']) !!}
    </div>
</div>

<div class="form-group">
    {!! Form::label('description_ru', 'description:', ['class' => 'col-sm-4 control-label required']) !!}
    <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
        {!! Form::text('description_ru',null ,['class' => 'form-control','required']) !!}
    </div>
</div>
