...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::select('product_id', \App\Models\CatalogProduct::select('id', \Illuminate\Support\Facades\DB::raw("CONCAT(upi_id, ' - ', name_ru) as name"))->lists('name','id'), null, ['class' => 'form-control', 'required']) !!}
    </div>
</div>
