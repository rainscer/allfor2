<div class="popup_block" id="contacts">
        ...
        <div class="row social">
            <div class="col-xs-12">
                <div class="col-xs-12 col-md-6">
                    <a href="https://www.facebook.com/allfor2com" target="_blank">
                        <img src="{{ asset('/images/fb_contacts.png') }}" alt="">
                    </a>
                </div>
                <div class="col-xs-12 col-md-6">
                    <a href="https://www.instagram.com/allfor2ua/" target="_blank">
    ...
    <div class="row info-ok">
        ...
        <div class="row">
            <h2 class="col-xs-12">Спасибо за заказ!<br>Мы свяжемся с Вами в ближайшее время!</h2>
