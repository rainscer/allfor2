    ...
    <div class="form-reviews" id="form-qa">
        ...
        @if (!Auth::check())
            <div class="form-group">
                {!! Form::text('name', null, ['class'=>'form-control qa-name', 'placeholder' => trans('product.username')] ) !!}
            </div>
            <div class="form-group">
        ...
        @else
            <div class="form-group">
                {!! Form::hidden('name', Auth::user()->getFullName(), ['class'=>'form-control qa-name'] ) !!}
            </div>
            @if(isset($user_city))
                <div class="form-group">
        ...
        <div class="form-group message-send-textarea">
            {!! Form::textarea('text', null, ['class'=>'form-control qa-text', 'size' => '50x5',
             'placeholder' => trans('product.yourQuestion')] ) !!}
        </div>
