                ...
                <table class="table tb-without-border deliv-cost">
                    ...
                    <tr class="product-basket-deliv">
                        ...
                        <td class="align-right product-basket-cost" colspan="2"><span class="ua-deliv-price">
                                {{--{{ $ua_deliv_price }}--}}${{ ceil($total_weight / 100) * 2 }} <span style="color: red;">*</span>
                            </span> {{--{{ $curency_code }}--}}
                        </td>
                    </tr>
                    {{--<tr class="product-basket-deliv">
                    ...
                    <tr>
                        <td colspan="3">* <span style="text-decoration: underline">цена доставки $2 за 100г веса {{ $total_weight % 100 ? ', так же Вы можете заказать еще товар весом до ' . (100 - $total_weight % 100) . 'г и сумма доставки не изменится' : '' }}</span></td>
                    </tr>
                </table>
